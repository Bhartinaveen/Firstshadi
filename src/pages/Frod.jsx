    ...
    <div className="bg-gray-100 min-h-screen flex justify-center items-start p-6">
      <div className="bg-white shadow-md rounded-lg p-8 max-w-3xl w-full">
        ...
        <p className="text-gray-900 mb-4">
          First Marriage.com is committed to offering a secure and trustworthy platform where users can search for potential life partners. While we strive to ensure a safe environment, we encourage users to remain vigilant and use personal judgment when interacting on our site.
        </p>
        ...
        <ul className="list-disc list-inside text-gray-900 space-y-2">
          ...
          <li>
            Beware of imitation websites pretending to be First Marriage.com. Always ensure you are visiting <strong className='text-blue-500'>www.firstmarriage.com</strong>.
          </li>
          <li>
          ...
          <li>
            First Marriage.com will never ask for your password, OTP, or confidential login details through calls, messages, or emails.
          </li>
          <li>
        ...
        <p className="text-gray-900 mt-6">
          First Marriage.com only facilitates initial introductions between individuals. Users must carry out their own due diligence before taking any decision. Verifying the authenticity of a profile rests with the user.
        </p>
