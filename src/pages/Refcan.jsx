    ...
    <div>
      <div className="max-w-4xl mx-auto p-6 text-gray-800 text-sm leading-6">
        <div className="bg-white rounded-2xl shadow-md p-6 md:p-10">
          ...
          <p className="mb-4">
            At <strong>First<span className="text-red-600"> Marriage</span></strong>, we strive to ensure that our users have a safe, smooth, and satisfactory experience. The following policy outlines the terms regarding cancellation of memberships and refunds.
          </p>
          <ul className="list-disc list-inside space-y-3">
            ...
            <li>
              In case of fraudulent or unauthorized use of the account, First<span className="text-red-600"> Marriage</span> reserves the right to suspend access without any refund.
            </li>
            <li>
              Any exceptions due to unforeseen circumstances will be handled solely at the discretion of <strong>First<span className="text-red-600"> Marriage</span></strong> support team.
            </li>
          </ul>
        </div>
      </div>
