      ...
      <div className="max-w-4xl mx-auto">
        <div className="bg-white rounded-lg shadow-md overflow-hidden">
          ...
          <div className="bg-indigo-600 p-6">
            ...
            <p className="text-indigo-100 mt-2">Last Updated: [Date]</p>
          </div>
          ...
          <div className="p-6 space-y-8">
            ...
            <div className="bg-gray-50 p-5 rounded-lg border border-gray-200">
              ...
              <p className="text-gray-600 mb-3">We use the collected information for various purposes:</p>
              <ul className="list-disc pl-6 text-gray-600 space-y-1 mb-3">
            ...
            {/* Section 5 */}
            <div className="bg-gray-50 p-5 rounded-lg border border-gray-200">
              <h2 className="text-2xl font-semibold text-gray-800 mb-3">5. Information Sharing</h2>
              <p className="text-gray-600 mb-3">
