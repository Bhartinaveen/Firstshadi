      ...
      <div className="bg-white rounded-lg shadow-md overflow-hidden">
        ...
        <div className="p-6 text-gray-800 leading-relaxed">
          <p className="text-sm sm:text-base mb-6">
            Welcome to First Marriage.com. By accessing or using our platform, you agree to these Terms & Conditions. If you do not agree, please do not use the platform.
          </p>
          ...
          <div className="space-y-6">
            <section>
              ...
              <p className="text-sm sm:text-base mt-2">
                First Marriage.com is a matrimonial platform for individuals intending to explore potential marriage alliances. It is not a dating or casual contact site.
              </p>
            </section>
            ...
            <section>
              ...
              <p className="text-sm sm:text-base mt-2">
                First Marriage.com is not liable for any financial or emotional loss resulting from user interaction.
              </p>
            </section>
            ...
            <section>
              ...
              <p className="text-sm sm:text-base mt-2">
                First Marriage.com are the exclusive property of the company and are protected by copyright and intellectual property laws. Any copying, reproduction, or distribution without prior written permission is strictly prohibited. Unauthorized use may lead to legal action.
