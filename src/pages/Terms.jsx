        ...
        <div className="bg-white rounded-lg shadow-md overflow-hidden">
          ...
          <div className="p-6 text-gray-800 leading-relaxed">
            <p className="text-sm sm:text-base mb-6">
              Welcome to First Marriage. By accessing or using our platform, you agree to these Terms & Conditions. If you do not agree, please do not use the platform.
            </p>

            <div className="space-y-6">
              <section>
                <h2 className="text-base sm:text-lg font-semibold text-blue-900">1. Usage and Purpose</h2>
                <p className="text-sm sm:text-base mt-2">
                  First Marriage is a matrimonial platform for individuals intending to explore potential marriage alliances. It is not a dating or casual contact site.
                </p>
              </section>

              <section>
                <h2 className="text-base sm:text-lg font-semibold text-blue-900">2. Account Responsibility</h2>
                <p className="text-sm sm:text-base mt-2">
              ...
              <section>
                <h2 className="text-base sm:text-lg font-semibold text-blue-900">3. Personal Data</h2>
                <p className="text-sm sm:text-base mt-2">
              ...
              <section>
                <h2 className="text-base sm:text-lg font-semibold text-blue-900">4. Acceptable Use</h2>
                <p className="text-sm sm:text-base mt-2">
              ...
              <section>
                <h2 className="text-base sm:text-lg font-semibold text-blue-900">5. Disclaimers</h2>
                <p className="text-sm sm:text-base mt-2">
                ...
                <p className="text-sm sm:text-base mt-2">
                  First Marriage is not liable for any financial or emotional loss resulting from user interaction.
                </p>
              </section>

              <section>
                <h2 className="text-base sm:text-lg font-semibold text-blue-900">6. Intellectual Property</h2>
                <p className="text-sm sm:text-base mt-2">
                  First Marriage materials are the exclusive property of the company and are protected by copyright and intellectual property laws. Any copying, reproduction, or distribution without prior written permission is strictly prohibited. Unauthorized use may lead to legal action.
                </p>
              </section>

              <section>
                <h2 className="text-base sm:text-lg font-semibold text-blue-900">7. Modifications</h2>
                <p className="text-sm sm:text-base mt-2">
              ...
              <section>
                <h2 className="text-base sm:text-lg font-semibold text-blue-900">8. Contact</h2>
                <p className="text-sm sm:text-base mt-2">
                  For queries regarding these terms, please contact us at{' '}
                  <a href="mailto:support@firstmarriage.online" className="text-blue-600 underline hover:text-blue-800">
